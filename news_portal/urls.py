...
urlpatterns = [
    path('admin/', admin.site.view_config if hasattr(admin.site, 'view_config') else admin.site.urls),
    ...
    path('edit-article/<int:pk>/', views.edit_article_view, name='edit-article'),
